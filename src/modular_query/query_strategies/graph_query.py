...
class GraphQueryStrategy(QueryStrategy):
    ...
    def create_query_graph(
        ...
        """Create a query graph for the given module graph."""
    ...
    def run_a_star(self, graph: nx.MultiDiGraph, final_module: str) -> dict[str, bool]:
        ...
        a_star_path = nx.astar_path(
            graph, "s_init", f"s_{final_module},success", weight="cost"
        )
    ...
    def get_expert_query_module(
        ...
        path = self.run_a_star(graph, final_module)
