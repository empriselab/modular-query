"""
A query strategy that uses a topological order to select the next module to query.

This is a simple query strategy that just queries the next module in the topological order.
"""
